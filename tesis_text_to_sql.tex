...
\subsubsection{Análisis de resultados sobre el conjunto conversacional}

El diálogo ilustrativo anterior alcanza un CRR del 100\% en sus cuatro turnos dependientes de contexto. Para verificar que este comportamiento se sostiene a escala, la retención de contexto se evaluó sobre el conjunto conversacional completo (Sección~\ref{sec:datasets}), que contiene \textbf{313 turnos de seguimiento dependientes de memoria}. En el 97,4\% de estos turnos (305/313), el sistema reconoció la referencia elíptica y reconstruyó la solicitud a partir de la entidad y la consulta establecidas en turnos previos, en lugar de tratar el mensaje como una petición aislada o pedir que el usuario repitiera la información.
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.68\linewidth]{Figura 5.11 - Contexto multiturno.png}
...
\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.82\linewidth]{Figura 5.10 - Gating multiturno.png}
...
\begin{thebibliography}{99}
	...
	L. Shi, Z. Tang, N. Zhang, X. Zhang, and Z. Yang, ``A survey on employing large language models for text-to-SQL tasks,'' \textit{ACM Comput. Surv.}, vol. 58, no. 2, pp. 1--37, 2025, doi: 10.1145/3737873.
	...
	Z. Hong et al., ``Next-generation database interfaces: A survey of LLM-based text-to-SQL,'' arXiv preprint arXiv:2406.08426, 2025.
	...
	H. Li, J. Zhang, C. Li, and H. Chen, ``RESDSQL: Decoupling schema linking and skeleton parsing for text-to-SQL,'' in \textit{Proc. AAAI}, Washington, DC, USA, 2023, pp. 13067--13075.
	...
	B. Zhang et al., ``Benchmarking the text-to-SQL capability of large language models: A comprehensive evaluation,'' arXiv preprint arXiv:2403.02951, 2024.
	...
	\bibitem{lee2024mcs}
	D. Lee, C. Park, J. Kim, and H. Park, ``MCS-SQL: Leveraging multiple prompts and multiple-choice selection for text-to-SQL generation,'' in \textit{Proc. COLING}, Abu Dhabi, UAE, 2025, pp. 337--353.
	...
	X. Zhu, Q. Li, L. Cui, and Y. Liu, ``Large language model enhanced text-to-SQL generation: A survey,'' arXiv preprint arXiv:2410.06011, 2024.
