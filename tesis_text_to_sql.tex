...
\IEEEPARstart{L}{a} generación de SQL, también conocida como Text-to-SQL, es una tarea fundamental del procesamiento del lenguaje natural cuyo propósito es convertir preguntas formuladas en lenguaje natural (NL) en consultas SQL ejecutables sobre bases de datos relacionales. Su objetivo central es democratizar el acceso a la información, permitiendo que usuarios sin conocimientos técnicos interactúen con los datos mediante expresiones propias de su lenguaje cotidiano \cite{liu2025survey, li2014nalir}.
...
\begin{thebibliography}{99}
	...
	\bibitem{li2024codes}
	H. Li et al., ``CodeS: Towards building open-source language models for text-to-SQL,'' \textit{Proc. ACM Manag. Data}, vol. 2, no. 3, pp. 1--28, 2024, doi: 10.1145/3654930.
	...
	D. Rai et al., ``Improving generalization in language model-based text-to-SQL semantic parsing: Two simple semantic boundary-based techniques,'' in \textit{Proc. ACL (Volume 2: Short Papers)}, Toronto, Canada, 2023, pp. 150--160, doi: 10.18653/v1/2023.acl-short.15.
